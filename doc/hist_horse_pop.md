...
<img src="hist_horse_pop_files/figure-gfm/plot horses-1.png" alt="Figure 1. Maximum and mininmun number of horses for each provinces between 1940 - 1972." width="100%" />

<p class="caption">

Figure 1. Maximum and mininmun number of horses for each provinces
between 1940 - 1972.
...
Table 1. Maximum and mininmun number of horses for each provinces
between 1940-1972
