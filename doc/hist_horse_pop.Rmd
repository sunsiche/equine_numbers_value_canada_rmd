...
```{r plot horses, fig.width=10, fig.height=3, fig.cap='Figure 1. Maximum and mininmun number of horses for each provinces between 1940 - 1972.', out.width='100%'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
kable(max_horses,
      caption = 'Table 1. Maximum and mininmun number of horses for each provinces between 1940-1972')
```
